...
# Usage:  Toast.show_toast("Wave cleared!", Color.GREEN)
#         Toast.show_toast("Saved", Color.WHITE, 1.5)
# -------------------------------------------------------
...
func _build() -> void:
	...
	_panel.offset_top    = _safe_y - 60.0   # hidden above viewport
...
func show_toast(text: String, color: Color = Color.WHITE, duration: float = DURATION) -> void:
	...
	# Reset to hidden position above screen
