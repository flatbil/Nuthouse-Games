...
#
# Provides:
#   make_panel_style()  — reusable StyleBoxFlat for panels
#   make_btn_style()    — reusable StyleBoxFlat for buttons
#   make_panel()        — ready-to-use PanelContainer
#   make_styled_btn()   — fully styled Button with press animation
#   add_press_anim()    — attach scale-pop animation to any Button
#   safe_top()          — top safe-area inset in logical pixels
#   safe_bottom()       — bottom safe-area inset in logical pixels
# -------------------------------------------------------
...
# Returns the top safe-area inset in logical viewport pixels.
...
# Returns the bottom safe-area inset in logical viewport pixels.
