...
signal game_over()
signal entity_died(pos: Vector2, is_enemy: bool)
signal enemy_dropped(position: Vector2, enemy_type: String)
signal gem_changed(total: int)
signal hero_weapon_changed(weapon_id: String)
